		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel-dead':
				...
				flipX = true;
                         ...
                         case 'nobody':
				// its nobody
				tex = Paths.getSparrowAtlas('characters/nobody_assets');
				frames = tex;
				animation.addByPrefix('idle', 'NobodyIdle', 24);
				animation.addByPrefix('singUP', 'Nobody Up', 24);
				animation.addByPrefix('singRIGHT', 'Nobody Right', 24);
				animation.addByPrefix('singDOWN', 'Nobody down', 24);
				animation.addByPrefix('singLEFT', 'Nobody Left', 24);
